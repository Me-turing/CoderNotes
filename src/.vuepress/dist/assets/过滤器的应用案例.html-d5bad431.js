import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,f as l}from"./app-c47b8d81.js";const s={},t=l(`<h2 id="post乱码处理" tabindex="-1"><a class="header-anchor" href="#post乱码处理" aria-hidden="true">#</a> POST乱码处理</h2><p>我们使用过滤器的特性,对所有的请求进行过滤,统一设置他的编码格式</p><h3 id="前端资源-login-jsp" tabindex="-1"><a class="header-anchor" href="#前端资源-login-jsp" aria-hidden="true">#</a> 前端资源 - login.jsp</h3><div class="language-JSP line-numbers-mode" data-ext="JSP"><pre class="language-JSP"><code>&lt;%@ page contentType=&quot;text/html;charset=UTF-8&quot; language=&quot;java&quot; %&gt;
&lt;html&gt;
  &lt;head&gt;
