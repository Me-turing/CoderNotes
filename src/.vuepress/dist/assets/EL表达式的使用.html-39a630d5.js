import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as t,f as l}from"./app-c47b8d81.js";const n={},d=l(`<h2 id="什么是el表达式" tabindex="-1"><a class="header-anchor" href="#什么是el表达式" aria-hidden="true">#</a> 什么是EL表达式</h2><p>EL表达式中定义了一些可以帮助我们快捷从域对象中取出数据的写法,基本语法为</p><div class="language-JSP line-numbers-mode" data-ext="JSP"><pre class="language-JSP"><code>\${域标志.数据名.属性名(可选)}
