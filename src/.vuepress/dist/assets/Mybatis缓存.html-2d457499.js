...
&lt;ehcache xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot;
    ...
    &lt;/defaultCache&gt;
&lt;/ehcache&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,50),J=e("br",null,null,-1),w=e("br",null,null,-1),I=e("img",{src:_,alt:"",loading:"lazy"},null,-1),X=e("br",null,null,-1),R=e("strong",null,"文件名必须叫做:ehcache.xml",-1),j=i('<h4 id="指定缓存管理器的具体类型" tabindex="-1"><a class="header-anchor" href="#指定缓存管理器的具体类型" aria-hidden="true">#</a> 指定缓存管理器的具体类型</h4><figure><img src="'+y+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-XML line-numbers-mode" data-ext="XML"><pre class="language-XML"><code>&lt;cache type=&quot;org.mybatis.caches.ehcache.EhcacheCache&quot;/&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="二级缓存机制" tabindex="-1"><a class="header-anchor" href="#二级缓存机制" aria-hidden="true">#</a> 二级缓存机制</h3><figure><img src="`+k+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>下面我们来看看CachingExecutor类中的query()方法在不同情况下使用的具体缓存对象<br> ①未开启二级缓存<br><img src="'+z+'" alt="" loading="lazy"><br> ②使用自带二级缓存<br><img src="'+B+'" alt="" loading="lazy"><br> ③使用EHCache<br><img src="'+T+'" alt="" loading="lazy"></p>',38);function F(H,U){const n=t("defalutCache");return l(),d("div",null,[O,e("p",null,[a("defaultCache标签各属性说明"),J,a(' 当借助CacheManager.add("缓存名称")创建Cache时，EhCache便会采用'),r(n),a("指定的的管理策略。"),w,I,X,R]),j])}const A=s(D,[["render",F],["__file","Mybatis缓存.html.vue"]]);export{A as default};
