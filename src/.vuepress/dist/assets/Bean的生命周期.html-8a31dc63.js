import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,f as a}from"./app-54a62cbe.js";const s={},l=a(`<h2 id="一般情况下的生命周期" tabindex="-1"><a class="header-anchor" href="#一般情况下的生命周期" aria-hidden="true">#</a> 一般情况下的生命周期</h2><h3 id="生命周期阶段" tabindex="-1"><a class="header-anchor" href="#生命周期阶段" aria-hidden="true">#</a> 生命周期阶段</h3><ol><li>通过构造器创建bean实例 -&gt; 执行构造器</li><li>为bean属性赋值 -&gt; 执行set方法</li><li>初始化bean -&gt; 调用bean的初始化方法,需要<code>init-method</code>参数配置指定调用的方法</li><li>bean的获取 -&gt; 容器对象 getBean方法</li><li>容器关闭销毁bean -&gt; 调用销毁方法,需要<code>destroy-method</code>参数配置指定调用的方法</li></ol><h3 id="相关代码" tabindex="-1"><a class="header-anchor" href="#相关代码" aria-hidden="true">#</a> 相关代码</h3><p>user.java 实体类</p><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Data  
@ToString  
public class User {  
