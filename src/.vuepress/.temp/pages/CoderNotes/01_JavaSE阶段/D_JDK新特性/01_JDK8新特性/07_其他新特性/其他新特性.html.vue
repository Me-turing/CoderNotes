<template><div><h2 id="重复注解" tabindex="-1"><a class="header-anchor" href="#重复注解" aria-hidden="true">#</a> 重复注解</h2>
<p>自从Java5中引用注解以来,注解开始变得非常流行.  并在哥哥框架和项目中被广泛使用. 不过注解有一个最大的限制是: 在同一个地方不能多次使用同一个注解. JDK8引入了重复注解的概念,允许在同一个对方多次使用同一个注解.</p>
<p>在JDK8 中使用<code v-pre>@Repeatable</code>注解定义重复注解.</p>
<ol>
<li>定义一个重复注解的容器<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Retention</span><span class="token punctuation">(</span><span class="token class-name">RetentionPolicy</span><span class="token punctuation">.</span><span class="token constant">RUNTIME</span><span class="token punctuation">)</span>
...
<li>使用重复注解<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@MyAnnotation</span><span class="token punctuation">(</span><span class="token string">"Test1"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/D_JDK新特性/01_JDK8新特性/07_其他新特性/image/image_6I2CnTU5bB.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>JDK8 为@Target原注解新增了两种类型: TYPE_PARAMETER TYPE_USE</p>
<ol>
<li>TYPE_PARAMETER : 表示该注解能卸载类型参数的声明语句中,类型参数声明如:&lt;T&gt;</li>
</ol>
