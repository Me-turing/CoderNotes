<template><div><h2 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求</h2>
<p>我们来模拟开发者常见的生产者和消费者模式，我们需要生产者创建指定类的对象，消费者访问这个类的对象。两者有序交替执行，</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/05_多线程/06_线程通信/image/image_GyemPw8EaI.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/05_多线程/06_线程通信/image/image_-ZQGLZ3Z90.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="注意点" tabindex="-1"><a class="header-anchor" href="#注意点" aria-hidden="true">#</a> 注意点</h2>
<ol>
<li>生产者和消费者之间需要保证线程的同步，我们需要采用同步锁的方式</li>
<li>注意同步监视器的设置，我们可以将同步监视器设置为共同的对象资源</li>
</ol>
<h2 id="案例" tabindex="-1"><a class="header-anchor" href="#案例" aria-hidden="true">#</a> 案例</h2>
<h3 id="使用synchronized的解决方案" tabindex="-1"><a class="header-anchor" href="#使用synchronized的解决方案" aria-hidden="true">#</a> 使用synchronized的解决方案</h3>
<blockquote>
<p>注意点：<br>
我们<strong>不可以在线程里面使用同步代码块</strong>，因为生产者和消费者是两个独立的线程，在使用线程阻塞的时候，我们拿到的锁也是独自的个体。所以我们需要在产品类中使用锁以及监视器</p>
</blockquote>
<p>synchronized使用的<strong>是一个等待池</strong>，这样<strong>只能对于一个生产者和一个消费者</strong>使用时可以正常，如果<strong>多个生产者和多个消费者</strong>时，<strong>还是会出现锁资源争抢的情况</strong>。</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/05_多线程/06_线程通信/image/image_CxSbtF-4WI.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>产品类</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestDemo13</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用lock的解决方案" tabindex="-1"><a class="header-anchor" href="#使用lock的解决方案" aria-hidden="true">#</a> 使用Lock的解决方案</h3>
<p>对于多个消费者和多个生产者的情况，单一的等待池就不够用了。我们需要使用Lock锁去对应的构建独自的等待池：</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/05_多线程/06_线程通信/image/image_g_5OVN5wDI.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>产品类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 商品类
 */</span>
