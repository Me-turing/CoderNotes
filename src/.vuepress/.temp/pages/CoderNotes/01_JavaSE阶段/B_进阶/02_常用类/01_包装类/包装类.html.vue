<template><div><h2 id="什么是包装类" tabindex="-1"><a class="header-anchor" href="#什么是包装类" aria-hidden="true">#</a> 什么是包装类</h2>
<p>在之前的学习中，我们使用的时基本数据类型来存储变量。而包装类是在基本数据类型的基础上，加上属性、特有方法、构造器进行封装。</p>
<p>它拥有更加灵活的操作方式以及API，在后面集合的学习中，我们需要操作的都是引用类型的数据。</p>
<p>同时，Java语言是面向对象的语言。与生俱来就更加擅长操作各种类。</p>
<h2 id="有哪些包装类" tabindex="-1"><a class="header-anchor" href="#有哪些包装类" aria-hidden="true">#</a> 有哪些包装类</h2>
<table>
<thead>
<tr>
<th>基本数据类型</th>
...
<td>byte</td>
<td>Byte</td>
<td>Byte → Number → Object</td>
</tr>
<tr>
<td>short</td>
<td>Short</td>
<td>Short → Number → Object</td>
</tr>
<tr>
<td>int</td>
<td>Integer</td>
<td>Integer → Number → Object</td>
</tr>
<tr>
<td>long</td>
<td>Long</td>
<td>Long → Number → Object</td>
</tr>
<tr>
<td>float</td>
<td>Float</td>
<td>Float → Number → Object</td>
</tr>
<tr>
<td>double</td>
<td>Double</td>
<td>Double → Number → Object</td>
</tr>
<tr>
<td>char</td>
<td>Character</td>
<td>Character → Object</td>
</tr>
<tr>
<td>boolean</td>
<td>Boolean</td>
...
<h2 id="装箱与拆箱" tabindex="-1"><a class="header-anchor" href="#装箱与拆箱" aria-hidden="true">#</a> 装箱与拆箱</h2>
<p>自动装箱  自动拆箱 是从<code v-pre>JDK1.5</code>以后新出的特性<br>
自动装箱就是将基本数据类型自动转换为封装类型，自动拆箱是将封装类型自动转换为基本数据类型</p>
<h3 id="代码演示" tabindex="-1"><a class="header-anchor" href="#代码演示" aria-hidden="true">#</a> 代码演示</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//自动装箱：int--->Integer</span>
...
<p>我们将上面的代码编译后，查看它的Class文件反编译代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//自动装箱：int--->Integer</span>
...
<li>我们看到他调用了<code v-pre>Integer</code>内置函数<code v-pre>valueof() </code>与 <code v-pre>intValue()</code>
<ul>
<li>自动装箱，相当于Java编译器替我们执行了 <code v-pre>Integer.valueOf(XXX);</code></li>
<li>自动拆箱，相当于Java编译器替我们执行了<code v-pre>Integer.intValue(XXX);</code></li>
</ul>
</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="详解integer" tabindex="-1"><a class="header-anchor" href="#详解integer" aria-hidden="true">#</a> 详解Integer</h2>
<p>所属的包：<code v-pre>java.lang.Integer</code><br>
继承关系：<code v-pre>java.lang.Object → java.lang.Nubmer → java.lang.Integer</code><br>
实现接口：<code v-pre>Serializable  Comparable&lt;Integer&gt;</code><br>
继承？ <code v-pre>被final修饰，不可以有子类</code><br>
出现版本：<code v-pre>JDK1.0</code><br>
属性： <code v-pre>Integer.MAX_VALUE → 最大取值</code>       <code v-pre>Integer.MIN_VALUE →  最小取值</code> <br>
特殊情况：<code v-pre>Integer.MAX_VALUE+1 = Integer.MIN_VALUE</code>  <code v-pre>Integer.MIN_VALUE-1 = Integer.MAX_VALUE</code>   详细原理见数据结构TODO<br>
构造器：<code v-pre>Integer没有空构造器</code>  <strong>可使用有参构造传入int或String</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Integer i1 = new Integer(12);</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>特殊缓存：<code v-pre>-128~127</code> <code v-pre> IntegerCache</code></p>
<p>在Integer中存在一个<code v-pre>IntegerCache</code>缓存数组，如果取值在 -128 \ ~127 则直接从缓存中取值，如果在缓存外，则会重新创建对应的对象初始化</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
...
<tbody>
<tr>
<td><code v-pre>Integer1.compareTo(Integer2)</code></td>
<td>对于两个Integer类型数值进行比较</td>
<td>小于：<code v-pre>return -1</code>  等于：<code v-pre>return 0</code>   大于：<code v-pre>return  1</code></td>
</tr>
<tr>
<td><code v-pre>Integer1.equals(Integer2)</code></td>
<td>比较两个Integer的值</td>
<td>等于：<code v-pre>true</code>  不等于：<code v-pre>false</code></td>
</tr>
<tr>
<td><code v-pre>Integer1.intValue()</code></td>
<td>Integer转int</td>
<td><code v-pre>int</code></td>
</tr>
<tr>
<td><code v-pre>Integer1.parseInt(String)</code></td>
<td>String转int</td>
<td><code v-pre>int</code></td>
</tr>
<tr>
<td><code v-pre>Integer1.toString()</code></td>
<td>Integer转String</td>
