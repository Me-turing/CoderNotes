...
<h3 id="什么是注解" tabindex="-1"><a class="header-anchor" href="#什么是注解" aria-hidden="true">#</a> 什么是注解</h3>
<p>注解其实就是代码里的特殊标记，这些标记可以在编译,类加载,运行时被读取,并执行相应的处理。</p>
<p>通过使用注解,程序员可以在不改变原有逻辑的情况下，在源文件中嵌入一些补充信息。代码分析工具、开发工具和部署工具可以通过这些补充信息进行验证或者进行部署。</p>
<p>使用注解时要在其前面增加@符号,并把该注解当成一个修饰符使用。用于修饰它支持的程序元素。</p>
<h3 id="注解的重要性" tabindex="-1"><a class="header-anchor" href="#注解的重要性" aria-hidden="true">#</a> 注解的重要性</h3>
<p>Annotation 可以像修饰符一样被使用，可用于修饰包，类，构造器,方法，成员变量,参数，局部变量的声明，这些信息被保存在Annotation的&quot;name=value&quot;对中。</p>
<p>在JavaSE中，注解的使用目的比较简单，例如标记过时的功能，忽略警告等。在JavaEE/ArIdroid中注解占据了更重要的角色，例如用来配置应用程序的任何切面，代替JavaEE旧版中所遗留的繁冗代码和XML配置等。</p>
<p>未来的开发模式都是基于注解的，JPA(java的持久化API)是基于注解的，Spring2.5以后都是基于注解的，Hibernate3.x以后也是基于注解的，现在的Struts2有一部分也是基于注解的了，注解是一种趋势，一定程度上可以说 ：框架=注解+反射+设计模式。</p>
<h2 id="junit-注解" tabindex="-1"><a class="header-anchor" href="#junit-注解" aria-hidden="true">#</a> Junit 注解</h2>
<p><code v-pre>@Before</code> <code v-pre>@After</code> <code v-pre>@Test</code></p>
<h2 id="文档注解" tabindex="-1"><a class="header-anchor" href="#文档注解" aria-hidden="true">#</a> 文档注解</h2>
<p><strong>说明注释</strong>允许你在程序中嵌入关于程序的信息。你可以使用 <strong>javadoc</strong> 工具软件来生成信息，并输出到HTML文件中。<br>
说明注释，使你更加方便的记录你的程序信息。</p>
<p><strong>文档注解</strong>我们一般使用在文档注释中，配合javadoc工具</p>
<h4 id="常见的文档注解" tabindex="-1"><a class="header-anchor" href="#常见的文档注解" aria-hidden="true">#</a> 常见的文档注解</h4>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_RzXsH0p42w.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p>其中注意 ：</p>
<ol>
<li>@param @return和@exception这三个标记都是只用于方法的。</li>
<li>@param的格式要求: @param 形参名 形参类型 形参说明</li>
<li>@return的格式要求: @return 返回值类型返回值说明，如果方法的返回值类型是void就不能写</li>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="idea的javadoc工具的使用" tabindex="-1"><a class="header-anchor" href="#idea的javadoc工具的使用" aria-hidden="true">#</a> IDEA的javadoc工具的使用</h3>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_SvQpahslO0.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_2QvUtOllv7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="jdk内置注解" tabindex="-1"><a class="header-anchor" href="#jdk内置注解" aria-hidden="true">#</a> JDK内置注解</h2>
<h3 id="override" tabindex="-1"><a class="header-anchor" href="#override" aria-hidden="true">#</a> @Override</h3>
<p>限定重写父类方法，该注解只能用于方法</p>
...
<span class="token punctuation">}</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="deprecated" tabindex="-1"><a class="header-anchor" href="#deprecated" aria-hidden="true">#</a> @Deprecated</h3>
<p>用于表示所修饰的元素(类,方法，构造器，属性等)已过时</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Student</span> <span class="token keyword">extends</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_cI8BD45xIY.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test02</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="简化配置文件" tabindex="-1"><a class="header-anchor" href="#简化配置文件" aria-hidden="true">#</a> 简化配置文件</h2>
<h3 id="在servlet3-0之前的配置" tabindex="-1"><a class="header-anchor" href="#在servlet3-0之前的配置" aria-hidden="true">#</a> 在servlet3.0之前的配置</h3>
...
<h3 id="创建自定义注解" tabindex="-1"><a class="header-anchor" href="#创建自定义注解" aria-hidden="true">#</a> 创建自定义注解</h3>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_JpxxKOBHFE.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_MXgOQ1_D_a.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p>注解并不是创建了接口，是<code v-pre>@interface</code>，跟接口没有一点关系</p>
</blockquote>
<h3 id="可以省略的元素" tabindex="-1"><a class="header-anchor" href="#可以省略的元素" aria-hidden="true">#</a> 可以省略的元素</h3>
<h4 id="省略value" tabindex="-1"><a class="header-anchor" href="#省略value" aria-hidden="true">#</a> 省略value</h4>
<p>如果自定义注解<strong>只有一个参数</strong>，使用时<code v-pre>可以省略value</code></p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_nl253b-b-D.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_YpKVcaERoD.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="设略赋值" tabindex="-1"><a class="header-anchor" href="#设略赋值" aria-hidden="true">#</a> 设略赋值</h4>
<p>如果自定义注解内部参数<strong>自带默认值</strong>，使用时<code v-pre>可以不赋值</code></p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_I0JMJ_DOQX.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_9HjJH9qwVJ.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p>如果自定义注解<strong>没有参数</strong>，那么实际上<strong>只是个标记</strong>，只有<strong>有参数的才是元注解</strong></p>
</blockquote>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_9_SS3I8wHQ.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_DssXDmw18d.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="元注解" tabindex="-1"><a class="header-anchor" href="#元注解" aria-hidden="true">#</a> 元注解</h2>
<p>元注解是用于修饰其它注解的注解</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_kbCsSRtaq1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>JDK5.0提供了四种元注解：<code v-pre>Retention</code>, <code v-pre>Target</code>, <code v-pre>Documented</code>, <code v-pre>Inherited</code></p>
<h3 id="retention" tabindex="-1"><a class="header-anchor" href="#retention" aria-hidden="true">#</a> @Retention</h3>
<p>用于修饰注解，<strong>用于指定修饰的那个注解的生命周期</strong>，@Rentention包含一个RetentionPolicy枚举类型的成员变量,使用@Rentention时必须为该value成员变量指定值:</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_jDfJ6ZEF0f.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong><code v-pre>RetentionPolicy.SOURCE</code></strong>:  在源文件中有效(即源文件保留),编译器直接丢弃这种策略的注释，在.class文件中不会保留注解信息</p>
<p><strong><code v-pre>RetentionPolicy.CLASS</code></strong>:   在class文件中有效(即class保留)，保留在.class文件中，但是当运行Java程序时，他就不会继续加载了，不会保留在内存中，JVM不会保留注解。<strong>如果注解没有加Retention元注解，那么相当于默认的注解就是这种状态。</strong></p>
<p><strong><code v-pre>RetentionPolicy.RUNTIME</code></strong>:   在运行时有效(即运行时保留),当运行 Java程序时，JVM会保留注释，加载在内存中了，那么程序可以通过反射获取该注释。</p>
<h3 id="target" tabindex="-1"><a class="header-anchor" href="#target" aria-hidden="true">#</a> @Target</h3>
<p>用于修饰注解的注解，用于指定被修饰的注解能用于修饰哪些程序元素。@Target也包含一个名为value的成员变量。</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_N7FiEy2vli.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>CONSTRUCTOR 表示可以在类上使用  METHOD表示可以在方法上使用  未注明的则不可以使用</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_Hh2RMRcix2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="documented-很少用" tabindex="-1"><a class="header-anchor" href="#documented-很少用" aria-hidden="true">#</a> @Documented(很少用）</h3>
<p>用于指定被该元注解修饰的注解类将被javadoc工具提取成文档。默认情况下，javadoc是 不包括注解的，但是加上了这个注解生成的文档中就会带着注解了</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_2u8Vmz9Y4z.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="inherited-极少用" tabindex="-1"><a class="header-anchor" href="#inherited-极少用" aria-hidden="true">#</a> @Inherited(极少用）</h3>
<p>被它修饰的Annotation将具有继承性。如果某个类使用了被@Inherited修饰的Annotation,则其子类将自动具有该注解。</p>
<p>如果MyAnno注解使用了@Inherited之后，就具备了继承性，那么相当于子类Student也使用了这个MyAnno</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_MFHca5LiZx.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</div></template>
