...
<img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/image_LkrQU4XeCx.png" alt="" loading="lazy"></p>
...
<img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/image_9b9j5wiXfj.png" alt="" loading="lazy"></p>
<p>在上面的双端队列的基础上 我们可以加以限制，获得：</p>
<p><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/image_9qDMEtjo1j.png" alt="" loading="lazy"><br>
<img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/image_NUryYc2oa2.png" alt="" loading="lazy"></p>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/image_1OghT8JIAt.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326121005.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122320.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
将last指针指向新增节点</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122348.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122416.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122518.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
一定要先取再放！！！</p>
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122632.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122705.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
     * 非阻塞类型
     * <span class="token keyword">@throws</span> <span class="token reference"><span class="token class-name">InterruptedException</span></span>
     */</span>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122815.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
     * 阻塞类型
     * <span class="token keyword">@throws</span> <span class="token reference"><span class="token class-name">InterruptedException</span></span>
     */</span>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326122848.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/01_JavaSE阶段/B_进阶/03_集合/13_队列/assets/Pasted_image_20230326120258.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>meturing<span class="token punctuation">.</span></span><span class="token class-name">Queue</span><span class="token punctuation">;</span>
