<template><div><p>相关资料<br>
<a href="file/Thymeleaf-3.0.11_B0zIAhCTc5.pdf">Thymeleaf-3.0.11.pdf</a><br>
<a href="file/Thymeleaf%E7%B1%BB%E5%BA%93_DL_WdBqpig.zip">Thymeleaf类库.zip</a></p>
<h2 id="mvc" tabindex="-1"><a class="header-anchor" href="#mvc" aria-hidden="true">#</a> MVC</h2>
<ul>
<li>M：Model模型</li>
<li>V：View视图</li>
<li>C：Controller控制器</li>
</ul>
<h3 id="为什么要使用mvc" tabindex="-1"><a class="header-anchor" href="#为什么要使用mvc" aria-hidden="true">#</a> 为什么要使用MVC</h3>
<p>我们如果只使用HTML作为视图的话，它是无法展示动态数据的，所以我们对HTML的新的期待：<strong>既能够正常显示页面，又能在页面中包含动态数据部分</strong>。而动态数据单靠HTML本身是无法做到的，所以此时我们需要引入服务器端动态视图模板技术。</p>
<h3 id="mvc和三层架构的关系" tabindex="-1"><a class="header-anchor" href="#mvc和三层架构的关系" aria-hidden="true">#</a> MVC和三层架构的关系</h3>
<p>MVC是在表述层开发中运用的一种设计理念。主张把<strong>封装数据的『模型』</strong>、<strong>显示用户界面的『视图』</strong>、协调调度的『控制器』分开。</p>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_5lPb_H-afR.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>我们在原有的表述层中，将servlet中对HTML的操作抽离出来，<strong>将Servlet只作为Controller控制器</strong>负责页面和数据之间的调度，<strong>将HTML页面只作为View视图</strong>负责数据渲染和提交响应，<strong>数据封装到Bean中作为Model模型</strong>贯穿三层架构</p>
<h2 id="thymeleaf概念" tabindex="-1"><a class="header-anchor" href="#thymeleaf概念" aria-hidden="true">#</a> Thymeleaf概念</h2>
<h3 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h3>
<p><strong>Thymeleaf是一款用于渲染XML/XHTML/HTML5内容的模板引擎。类似JSP，Velocity，FreeMaker等， 它也可以轻易的与Spring MVC等Web框架进行集成作为Web应用的模板引擎。它的主要作用是在静态页面上渲染显示动态数据</strong></p>
...
<ul>
<li>将视图层文件归并到web-inf下的view文件</li>
<li>在web.xml文件中配置逻辑视图路径</li>
<li>在Servlet中新建一个基类</li>
<li>新的Servlet继承基类，通过processTemplate方法跳转视图</li>
</ul>
<h2 id="thymeleaf的基本语法" tabindex="-1"><a class="header-anchor" href="#thymeleaf的基本语法" aria-hidden="true">#</a> Thymeleaf的基本语法</h2>
<h3 id="th名称空间" tabindex="-1"><a class="header-anchor" href="#th名称空间" aria-hidden="true">#</a> th名称空间</h3>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_pHFg0pNqBH.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="表达式语法" tabindex="-1"><a class="header-anchor" href="#表达式语法" aria-hidden="true">#</a> 表达式语法</h3>
<p>任何HTML标签原有的属性，前面加上『th:』就都可以通过Thymeleaf来设定新值。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="修改文本" tabindex="-1"><a class="header-anchor" href="#修改文本" aria-hidden="true">#</a> 修改文本</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="修改属性" tabindex="-1"><a class="header-anchor" href="#修改属性" aria-hidden="true">#</a> 修改属性</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="解析url" tabindex="-1"><a class="header-anchor" href="#解析url" aria-hidden="true">#</a> 解析URL</h4>
...
<p>注意 : 不经过服务器解析，直接用浏览器打开HTML文件，看到的是『标签体原始值』, 经过服务器解析，Thymeleaf引擎根据<code v-pre>th:text</code>属性指定的『标签体新值』去替换『标签体原始值』</p>
</blockquote>
<h3 id="域对象的使用" tabindex="-1"><a class="header-anchor" href="#域对象的使用" aria-hidden="true">#</a> 域对象的使用</h3>
<h4 id="全局域-servletcontext" tabindex="-1"><a class="header-anchor" href="#全局域-servletcontext" aria-hidden="true">#</a> 全局域 ServletContext</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token comment">//Servlet代码 全局域 服务器关闭才关闭</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="请求域-request-setattribute" tabindex="-1"><a class="header-anchor" href="#请求域-request-setattribute" aria-hidden="true">#</a> 请求域 request.setAttribute</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token comment">//请求域 仅限于当前请求</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="会话-session" tabindex="-1"><a class="header-anchor" href="#会话-session" aria-hidden="true">#</a> 会话 session</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//session域  仅限于当前用户会话</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="请求参数的使用" tabindex="-1"><a class="header-anchor" href="#请求参数的使用" aria-hidden="true">#</a> 请求参数的使用</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="获取一个请求参数" tabindex="-1"><a class="header-anchor" href="#获取一个请求参数" aria-hidden="true">#</a> 获取一个请求参数</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="获取多个请求参数" tabindex="-1"><a class="header-anchor" href="#获取多个请求参数" aria-hidden="true">#</a> 获取多个请求参数</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="访问servlet并附带请求参数" tabindex="-1"><a class="header-anchor" href="#访问servlet并附带请求参数" aria-hidden="true">#</a> 访问Servlet并附带请求参数</h4>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name"><span class="token namespace">th:</span>href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>@{user(method='toRegisterPage')}<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>register<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>注册<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>@{user(method='toRegisterPage')</code>  表示访问：<code v-pre>http://localhost:8080/webday09/user?method=toRegisterPage</code></p>
<h2 id="thymeleaf的内置对象" tabindex="-1"><a class="header-anchor" href="#thymeleaf的内置对象" aria-hidden="true">#</a> Thymeleaf的内置对象</h2>
<p>所谓内置对象其实就是<strong>在Thymeleaf的表达式中可以直接使用的对象</strong></p>
<h3 id="基本内置对象" tabindex="-1"><a class="header-anchor" href="#基本内置对象" aria-hidden="true">#</a> 基本内置对象</h3>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_yeyatvWmxH.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>使用request对象<span class="token operator">--</span><span class="token operator">></span>
...
<li><strong>如果不清楚这个对象有哪些方法可以使用，那么就通过getClass().getName()获取全类名，再回到Java环境查看这个对象有哪些方法</strong></li>
<li>内置对象的方法可以直接调用</li>
<li>调用方法时需要传参的也可以直接传入参数</li>
</ul>
<h3 id="公共内置对象" tabindex="-1"><a class="header-anchor" href="#公共内置对象" aria-hidden="true">#</a> 公共内置对象</h3>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_O_OeRosvNd.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>lists内置对象<span class="token operator">--</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>公共内置对象的源码位置</p>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_wLgALIXOVO.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="ognl语法" tabindex="-1"><a class="header-anchor" href="#ognl语法" aria-hidden="true">#</a> OGNL语法</h2>
<p>OGNL：Object-Graph Navigation Language对象-图 导航语言</p>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_c0tjkVb5CZ.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong>从根对象触发</strong>，通过特定的语法，逐层访问对象的各种属性。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在Thymeleaf环境下，<code v-pre>${}</code>中的表达式可以从下列元素开始：</p>
<ul>
<li>访问属性域的起点
<ul>
<li>请求域属性名</li>
...
<h3 id="分支与迭代" tabindex="-1"><a class="header-anchor" href="#分支与迭代" aria-hidden="true">#</a> 分支与迭代</h3>
<h4 id="分支" tabindex="-1"><a class="header-anchor" href="#分支" aria-hidden="true">#</a> 分支</h4>
<h5 id="if和unles" tabindex="-1"><a class="header-anchor" href="#if和unles" aria-hidden="true">#</a> if和unles</h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="switch" tabindex="-1"><a class="header-anchor" href="#switch" aria-hidden="true">#</a> switch</h5>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="迭代" tabindex="-1"><a class="header-anchor" href="#迭代" aria-hidden="true">#</a> 迭代</h3>
<p>类似于<code v-pre>vue中的v-for</code>对集合进行迭代遍历，每次遍历出来一条数据就添加一个标签<br>
语法 :<code v-pre> th:each=&quot;遍历出来的数据，数据的状态 ：要遍历的数据&quot;</code></p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- Servlet代码 --></span>
//往请求域中存储一个teacher对象
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>table</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每次遍历出来一条数据就添加一个标签</p>
<h2 id="包含其他页面模板" tabindex="-1"><a class="header-anchor" href="#包含其他页面模板" aria-hidden="true">#</a> 包含其他页面模板</h2>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/03_前端技术/09_Thymeleaf/image/image_5KASsuWjeu.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="创建模板" tabindex="-1"><a class="header-anchor" href="#创建模板" aria-hidden="true">#</a> 创建模板</h3>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name"><span class="token namespace">th:</span>fragment</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>模板名称<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用模板" tabindex="-1"><a class="header-anchor" href="#使用模板" aria-hidden="true">#</a> 使用模板</h3>
<table>
<thead>
<tr>
<th>语法</th>
...
<tr>
<td>th:include</td>
<td>把目标的代码片段去除最外层标签，然后再插入到当前标签内部</td>
<td>它会去掉片段外层标记，同时保留页面自身标记</td>
</tr>
</tbody>
</table>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 代码片段所在页面的逻辑视图 :: 代码片段的名称 --></span>
