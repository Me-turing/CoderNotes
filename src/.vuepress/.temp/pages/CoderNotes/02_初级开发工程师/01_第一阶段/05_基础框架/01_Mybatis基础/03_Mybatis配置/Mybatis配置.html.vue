...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409180127.png" alt="" loading="lazy"></p>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409180306.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409180815.png" alt="" loading="lazy"></p>
...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409180649.png" alt="" loading="lazy"></p>
<h5 id="效果-1" tabindex="-1"><a class="header-anchor" href="#效果-1" aria-hidden="true">#</a> 效果</h5>
<p>我们发现Log4j2的日志打印的更加详细<br>
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409180901.png" alt="" loading="lazy"></p>
...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409181124.png" alt="" loading="lazy"><br>
...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409181531.png" alt="" loading="lazy"></p>
<p>我们看到官方说明文档中,在settings配置中可以指定log框架,所以我们新增logImpl属性配置<br>
如果没有配置,默认情况下Mybatis会自动按照顺序寻找使用的log框架<br>
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409181332.png" alt="" loading="lazy"></p>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409190001.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409190305.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409191334.png" alt="" loading="lazy"></p>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409191710.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409191849.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409192056.png" alt="" loading="lazy"></p>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409195042.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><code v-pre>properties</code>属性可以在外部进行配置，并可以进行动态替换。你既可以在典型的 Java 属性文件中配置这些属性，也可以在 properties 元素的子元素中设置。例如：</p>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409194918.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409194955.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409200018.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>下面是一些为常见的 Java 类型内建的类型别名。它们都是不区分大小写的，注意，为了应对原始类型的命名重复，采取了特殊的命名风格。</p>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/05_基础框架/01_Mybatis基础/03_Mybatis配置/assets/Pasted_image_20230409195842.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>总结来说:</p>
