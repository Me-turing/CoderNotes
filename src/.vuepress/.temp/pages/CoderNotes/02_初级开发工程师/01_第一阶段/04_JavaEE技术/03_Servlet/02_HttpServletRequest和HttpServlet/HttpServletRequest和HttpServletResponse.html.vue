<template><div><h2 id="httpservletrequest" tabindex="-1"><a class="header-anchor" href="#httpservletrequest" aria-hidden="true">#</a> HttpServletRequest</h2>
<p>HttpServletRequest对象代表客户端浏览器的请求，当客户端浏览器通过HTTP协议访问服务器时，HTTP请求中的所有信息都会被Tomcat所解析并封装在这个对象中，通过这个对象提供的方法，可以获得客户端请求的所有信息。</p>
<h3 id="了解请求结构" tabindex="-1"><a class="header-anchor" href="#了解请求结构" aria-hidden="true">#</a> 了解请求结构</h3>
<p>请求的主要组成部分</p>
<h3 id="获取请求行" tabindex="-1"><a class="header-anchor" href="#获取请求行" aria-hidden="true">#</a> 获取请求行</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<tr>
<td>getLocalPort()</td>
<td>返回WEB服务器处理Http协议的连接器所监听的端口</td>
</tr>
</tbody>
</table>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取请求头信息" tabindex="-1"><a class="header-anchor" href="#获取请求头信息" aria-hidden="true">#</a> 获取请求头信息</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<tbody>
<tr>
<td>getHeader(&quot;headerKey&quot;)</td>
<td>根据请求头中的key获取对应的value</td>
</tr>
<tr>
<td>getHeaderNames()</td>
<td>获取请求头中所有的key，该方法返回枚举类型</td>
</tr>
</tbody>
</table>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Servlet3</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取请求体信息" tabindex="-1"><a class="header-anchor" href="#获取请求体信息" aria-hidden="true">#</a> 获取请求体信息</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<tbody>
<tr>
<td>getParameter(&quot;key&quot;)</td>
<td>根据key获取指定value</td>
</tr>
<tr>
<td>getParameterValues(&quot;checkboxkey&quot;)</td>
<td>获取复选框(checkbox组件)中的值，返回一个String[]</td>
</tr>
<tr>
<td>getParameterNames()</td>
<td>获取请求中所有数据的key，该方法返回一个枚举类型</td>
</tr>
<tr>
<td>getParameterMap()</td>
<td>获取请求中所有的数据并存放到一个Map结构中，该方法返回一个Map，其中key为String类型value为String[]类型</td>
</tr>
<tr>
...
<p>请求的数据包基于字节在网络上传输，Tomcat接收到请求的数据包后会将数据包中的字节转换为字符。</p>
<p>在Tomcat中使用的是ISO-8859-1的单字节编码完成字节与字符的转换，所以数据中含有中文就会出现乱码，可以<strong>通过req.setCharacterEncoding(&quot;utf-8&quot;)方法来对提交的数据根据指定的编码方式重新做编码处理</strong>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Servlet3</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">service</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
        <span class="token comment">// 根据请求头名或者请求头对应的值</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="httpservletresponse" tabindex="-1"><a class="header-anchor" href="#httpservletresponse" aria-hidden="true">#</a> HttpServletResponse</h2>
<p>HttpServletResponse对象代表服务器的响应。这个对象中封装了响应客户端浏览器的流对象，以及向客户端浏览器响应的响应头、响应数据、响应状态码等信息。</p>
<h3 id="了解响应" tabindex="-1"><a class="header-anchor" href="#了解响应" aria-hidden="true">#</a> 了解响应</h3>
<p>HTTP响应</p>
<h3 id="响应状态" tabindex="-1"><a class="header-anchor" href="#响应状态" aria-hidden="true">#</a> 响应状态</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<p>设置响应状态</p>
<p>更多类型详见: HTTP状态码分类</p>
<h3 id="响应类型设置" tabindex="-1"><a class="header-anchor" href="#响应类型设置" aria-hidden="true">#</a> 响应类型设置</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<td>通过MIME-Type设置响应类型</td>
</tr>
</tbody>
</table>
<p>MIME的全称是Multipurpose Internet Mail Extensions，即多用途互联网邮件扩展类型。这是HTTP协议中用来定义文档性质及格式的标准。对HTTP传输内容类型进行了全面定义。服务器通过MIME告知响应内容类型，而浏览器则通过MIME类型来确定如何处理文档。</p>
<p>更多类型详见: Content-Type</p>
<h3 id="设置字符型响应" tabindex="-1"><a class="header-anchor" href="#设置字符型响应" aria-hidden="true">#</a> 设置字符型响应</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<tbody>
<tr>
<td>setContentType(&quot;image/jpeg&quot;)</td>
<td>设置响应类型为图片类型，图片类型为jpeg或jpg格式</td>
</tr>
<tr>
<td>setContentType(&quot;image/gif&quot;)</td>
<td>设置响应类型为图片类型，图片类型为gif格式</td>
</tr>
<tr>
<td>setCharacterEncoding(&quot;utf-8&quot;)</td>
<td>设置服务端为浏览器产生响应的响应编码，服务端会根据此编码将响应内容的字符转换为字节</td>
</tr>
<tr>
<td>setContentType(&quot;text/html;charset=utf-8&quot;)</td>
<td>设置服务端为浏览器产生响应的响应编码，服务端会根据此编码将响应内容的字符转换为字节。同时客户端浏览器会根据此编码方式显示响应内容。</td>
</tr>
</tbody>
</table>
<h3 id="设置文件下载" tabindex="-1"><a class="header-anchor" href="#设置文件下载" aria-hidden="true">#</a> 设置文件下载</h3>
<table>
<thead>
<tr>
<th>API</th>
...
<tbody>
<tr>
<td>setHeader(&quot;Content-Disposition&quot;,   &quot;attachment; filename=&quot;+文件名)</td>
<td>该附加信息表示作为对下载文件的一个标识字段。不会在浏览器中显示而是直接做下载处理</td>
</tr>
</tbody>
</table>
<p><code v-pre>Content-Disposition:attachment</code>  : 该附加信息表示作为对下载文件的一个标识字段。不会在浏览器中显示而是直接做下载处理</p>
<p><code v-pre>filename=文件名</code> : 表示指定下载文件的文件名</p>
