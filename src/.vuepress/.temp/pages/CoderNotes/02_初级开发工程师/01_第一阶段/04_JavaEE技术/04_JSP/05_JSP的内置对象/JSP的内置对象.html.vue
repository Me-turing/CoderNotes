<template><div><h2 id="什么是内置对象" tabindex="-1"><a class="header-anchor" href="#什么是内置对象" aria-hidden="true">#</a> 什么是内置对象</h2>
<p>因为JSP的本质是Servlet,在JSP文件经过转译之后,生成JAVA代码,在运行时,JSP给我们准备好了九个可以直接使用而不用我们自己去new的对象,这九个对象我们称之为内置对象.<strong>内置对象完全有JSP自行去维护,我们直接使用即可</strong></p>
<h2 id="jsp的九大内置对象" tabindex="-1"><a class="header-anchor" href="#jsp的九大内置对象" aria-hidden="true">#</a> JSP的九大内置对象</h2>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/04_JavaEE技术/04_JSP/05_JSP的内置对象/assets/Pasted_image_20230403222859.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="四个域对象" tabindex="-1"><a class="header-anchor" href="#四个域对象" aria-hidden="true">#</a> 四个域对象</h3>
<table>
<thead>
<tr>
...
<td style="text-align:left">page域</td>
<td style="text-align:left">当前页面内可用</td>
</tr>
<tr>
<td style="text-align:left">request</td>
<td style="text-align:left">request域</td>
<td style="text-align:left">单次请求</td>
</tr>
<tr>
<td style="text-align:left">session</td>
<td style="text-align:left">session域</td>
<td style="text-align:left">单次会话</td>
</tr>
<tr>
<td style="text-align:left">application</td>
<td style="text-align:left">application域</td>
<td style="text-align:left">项目运行</td>
</tr>
</tbody>
</table>
<h3 id="响应对象" tabindex="-1"><a class="header-anchor" href="#响应对象" aria-hidden="true">#</a> 响应对象</h3>
<table>
<thead>
<tr>
<th style="text-align:left">内置对象</th>
...
<td style="text-align:left">响应对象</td>
</tr>
</tbody>
</table>
<h3 id="输出流对象" tabindex="-1"><a class="header-anchor" href="#输出流对象" aria-hidden="true">#</a> 输出流对象</h3>
<table>
<thead>
<tr>
<th style="text-align:left">内置对象</th>
...
<h3 id="其他三个对象" tabindex="-1"><a class="header-anchor" href="#其他三个对象" aria-hidden="true">#</a> 其他三个对象</h3>
<table>
<thead>
<tr>
<th style="text-align:left">内置对象</th>
...
<td style="text-align:left">由于JSP本身也是一个Servlet,所以容器也会给我们准备一个ServletConfig</td>
</tr>
<tr>
<td style="text-align:left">page</td>
<td style="text-align:left">就是他this对象 当前JSP对象本身</td>
</tr>
<tr>
<td style="text-align:left">exception</td>
<td style="text-align:left">异常对象,在错误提示页上使用,当isErrorpage=true 才具有该对象</td>
</tr>
</tbody>
</table>
<h2 id="九大内置对象的使用" tabindex="-1"><a class="header-anchor" href="#九大内置对象的使用" aria-hidden="true">#</a> 九大内置对象的使用</h2>
<p>实体类</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Servlet代码</p>
...
<div class="language-JSP line-numbers-mode" data-ext="JSP"><pre v-pre class="language-JSP"><code>&lt;%@ page import=&quot;com.meturing.pojo.User&quot; %&gt;
...
&lt;/body&gt;
&lt;/html&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="综合案例开发" tabindex="-1"><a class="header-anchor" href="#综合案例开发" aria-hidden="true">#</a> 综合案例开发</h2>
<p>链接数据库显示所有员工信息到JSP页面,表格如下</p>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/04_JavaEE技术/04_JSP/05_JSP的内置对象/assets/Pasted_image_20230403223854.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="构建项目结构" tabindex="-1"><a class="header-anchor" href="#构建项目结构" aria-hidden="true">#</a> 构建项目结构</h3>
<figure><img src="@source/CoderNotes/02_初级开发工程师/01_第一阶段/04_JavaEE技术/04_JSP/05_JSP的内置对象/assets/Pasted_image_20230403223935.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="匹配规则" tabindex="-1"><a class="header-anchor" href="#匹配规则" aria-hidden="true">#</a> 匹配规则</h3>
<p>0-500     A<br>
501-1000  B<br>
1001-1500  C<br>
1501-2000  D<br>
...
<p>实体类</p>
<div class="language-Java line-numbers-mode" data-ext="Java"><pre v-pre class="language-Java"><code>public class Emp implements Serializable {
...
<div class="language-Java line-numbers-mode" data-ext="Java"><pre v-pre class="language-Java"><code>public class EmpDaoImpl implements EmpDao {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>servlet代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/empServlet.do"</span><span class="token punctuation">)</span>
