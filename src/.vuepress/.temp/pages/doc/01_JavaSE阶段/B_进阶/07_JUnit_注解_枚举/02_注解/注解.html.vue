...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_RzXsH0p42w.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p>其中注意 ：</p>
<ol>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_SvQpahslO0.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_2QvUtOllv7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Student</span> <span class="token keyword">extends</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_cI8BD45xIY.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_JpxxKOBHFE.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_MXgOQ1_D_a.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_nl253b-b-D.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_YpKVcaERoD.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_I0JMJ_DOQX.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_9HjJH9qwVJ.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p>如果自定义注解<strong>没有参数</strong>，那么实际上<strong>只是个标记</strong>，只有<strong>有参数的才是元注解</strong></p>
</blockquote>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_9_SS3I8wHQ.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_DssXDmw18d.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="元注解" tabindex="-1"><a class="header-anchor" href="#元注解" aria-hidden="true">#</a> 元注解</h2>
<p>元注解是用于修饰其它注解的注解</p>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_kbCsSRtaq1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_jDfJ6ZEF0f.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_N7FiEy2vli.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>CONSTRUCTOR 表示可以在类上使用  METHOD表示可以在方法上使用  未注明的则不可以使用</p>
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_Hh2RMRcix2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_2u8Vmz9Y4z.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/doc/01_JavaSE阶段/B_进阶/07_JUnit_注解_枚举/02_注解/image/image_MFHca5LiZx.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</div></template>
