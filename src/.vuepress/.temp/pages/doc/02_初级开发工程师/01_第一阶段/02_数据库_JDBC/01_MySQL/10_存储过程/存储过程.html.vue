<template><div><h2 id="什么是存储过程-stored-procedure" tabindex="-1"><a class="header-anchor" href="#什么是存储过程-stored-procedure" aria-hidden="true">#</a> 什么是存储过程(Stored Procedure)</h2>
...
<h2 id="存储过程的优点" tabindex="-1"><a class="header-anchor" href="#存储过程的优点" aria-hidden="true">#</a> 存储过程的优点</h2>
<ol>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 定义一个没有返回值 存储过程</span>
