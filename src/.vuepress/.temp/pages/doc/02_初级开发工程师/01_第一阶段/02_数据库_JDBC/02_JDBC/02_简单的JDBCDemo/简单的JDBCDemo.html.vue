...
<img src="@source/doc/02_初级开发工程师/01_第一阶段/02_数据库+JDBC/02_JDBC/02_简单的JDBCDemo/image/image_Rtxr67BN3t.png" alt="" loading="lazy"></li>
<li>给当前项目添加依赖(告诉当前项目/模块可以依赖jar文件中的代码)<br>
<img src="@source/doc/02_初级开发工程师/01_第一阶段/02_数据库+JDBC/02_JDBC/02_简单的JDBCDemo/image/image_U2ReBUV-S2.png" alt="" loading="lazy"></li>
<li>点击OK<br>
<img src="@source/doc/02_初级开发工程师/01_第一阶段/02_数据库+JDBC/02_JDBC/02_简单的JDBCDemo/image/image_GJ0i0pCQkX.png" alt="" loading="lazy"></li>
</ol>
...
<figure><img src="@source/doc/02_初级开发工程师/01_第一阶段/02_数据库+JDBC/02_JDBC/02_简单的JDBCDemo/image/image_NeNJyTzuiH.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
