<template><div><h2 id="ddl-数据库定义语言" tabindex="-1"><a class="header-anchor" href="#ddl-数据库定义语言" aria-hidden="true">#</a> DDL 数据库定义语言</h2>
<h3 id="操作数据库" tabindex="-1"><a class="header-anchor" href="#操作数据库" aria-hidden="true">#</a> 操作数据库</h3>
<h4 id="创建数据库" tabindex="-1"><a class="header-anchor" href="#创建数据库" aria-hidden="true">#</a> 创建数据库</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">database</span> 数据库名 <span class="token punctuation">[</span><span class="token keyword">character</span> <span class="token keyword">set</span> 字符集<span class="token punctuation">]</span><span class="token punctuation">[</span><span class="token keyword">collate</span>  校对规则<span class="token punctuation">]</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查询所有数据库" tabindex="-1"><a class="header-anchor" href="#查询所有数据库" aria-hidden="true">#</a> 查询所有数据库</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查询某个数据库的结构" tabindex="-1"><a class="header-anchor" href="#查询某个数据库的结构" aria-hidden="true">#</a> 查询某个数据库的结构</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">show</span> <span class="token keyword">create</span> <span class="token keyword">database</span> 数据库名<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查询当前正在使用哪个数据库" tabindex="-1"><a class="header-anchor" href="#查询当前正在使用哪个数据库" aria-hidden="true">#</a> 查询当前正在使用哪个数据库</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="修改数据库的字符集" tabindex="-1"><a class="header-anchor" href="#修改数据库的字符集" aria-hidden="true">#</a> 修改数据库的字符集</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">database</span> 数据库名 <span class="token keyword">character</span> <span class="token keyword">set</span> 字符集<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="选中某个数据库" tabindex="-1"><a class="header-anchor" href="#选中某个数据库" aria-hidden="true">#</a> 选中某个数据库</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="删除数据库" tabindex="-1"><a class="header-anchor" href="#删除数据库" aria-hidden="true">#</a> 删除数据库</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">drop</span> <span class="token keyword">database</span> 数据库名<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="表的操作" tabindex="-1"><a class="header-anchor" href="#表的操作" aria-hidden="true">#</a> 表的操作</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="一般创建" tabindex="-1"><a class="header-anchor" href="#一般创建" aria-hidden="true">#</a> 一般创建</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 创建数据库表：</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="快速创建" tabindex="-1"><a class="header-anchor" href="#快速创建" aria-hidden="true">#</a> 快速创建</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 添加一张表：快速添加：结构和数据跟t_student 都是一致的</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="修改表" tabindex="-1"><a class="header-anchor" href="#修改表" aria-hidden="true">#</a> 修改表</h4>
<h5 id="添加一个字段" tabindex="-1"><a class="header-anchor" href="#添加一个字段" aria-hidden="true">#</a> 添加一个字段</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">//添加一个字段，默认在最后添加</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="修改表的字段类型和约束" tabindex="-1"><a class="header-anchor" href="#修改表的字段类型和约束" aria-hidden="true">#</a> 修改表的字段类型和约束</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">table</span> 表名 <span class="token keyword">modify</span> 字段 类型 约束 ；<span class="token punctuation">`</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="修改列的名字" tabindex="-1"><a class="header-anchor" href="#修改列的名字" aria-hidden="true">#</a> 修改列的名字</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">table</span> 表名 change 旧列 新列 类型 约束<span class="token punctuation">;</span><span class="token punctuation">`</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="删除字段" tabindex="-1"><a class="header-anchor" href="#删除字段" aria-hidden="true">#</a> 删除字段</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">table</span> 表名 <span class="token keyword">drop</span> 列名<span class="token punctuation">;</span><span class="token punctuation">`</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="修改表名" tabindex="-1"><a class="header-anchor" href="#修改表名" aria-hidden="true">#</a> 修改表名</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token identifier"><span class="token punctuation">`</span>rename table 旧表名 to 新表名;<span class="token punctuation">`</span></span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查询所有表" tabindex="-1"><a class="header-anchor" href="#查询所有表" aria-hidden="true">#</a> 查询所有表</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查询某张表的结构" tabindex="-1"><a class="header-anchor" href="#查询某张表的结构" aria-hidden="true">#</a> 查询某张表的结构</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查看建表语句" tabindex="-1"><a class="header-anchor" href="#查看建表语句" aria-hidden="true">#</a> 查看建表语句</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 查看建表语句：</span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="删除表" tabindex="-1"><a class="header-anchor" href="#删除表" aria-hidden="true">#</a> 删除表</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">drop</span> <span class="token keyword">table</span> 表名；
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="清空表" tabindex="-1"><a class="header-anchor" href="#清空表" aria-hidden="true">#</a> 清空表</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 删除数据操作 :清空数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="dml" tabindex="-1"><a class="header-anchor" href="#dml" aria-hidden="true">#</a> DML</h2>
<h3 id="插入数据" tabindex="-1"><a class="header-anchor" href="#插入数据" aria-hidden="true">#</a> 插入数据</h3>
<h4 id="指定插入的列" tabindex="-1"><a class="header-anchor" href="#指定插入的列" aria-hidden="true">#</a> 指定插入的列</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">insert</span> <span class="token keyword">into</span> 表名<span class="token punctuation">(</span>列<span class="token punctuation">,</span>列<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">)</span> <span class="token keyword">values</span><span class="token punctuation">(</span>值<span class="token punctuation">,</span>值<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="不指定插入的列" tabindex="-1"><a class="header-anchor" href="#不指定插入的列" aria-hidden="true">#</a> 不指定插入的列</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">insert</span> <span class="token keyword">into</span> 表名 <span class="token keyword">values</span><span class="token punctuation">(</span>值<span class="token punctuation">,</span>值<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">)</span><span class="token punctuation">;</span>   
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="例子" tabindex="-1"><a class="header-anchor" href="#例子" aria-hidden="true">#</a> 例子</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 在t_student数据库表中插入数据：</span>
...
<li>int  宽度是显示宽度，如果超过，可以自动增大宽度 int底层都是4个字节</li>
<li>时间的方式多样  '1256-12-23'  &quot;1256/12/23&quot;  &quot;1256.12.23&quot;</li>
<li>字符串不区分单引号和双引号</li>
<li>如何写入当前的时间  <code v-pre>now()</code> ,<code v-pre> sysdate()</code> ,<code v-pre>CURRENT\_DATE()</code></li>
<li>char varchar 是字符的个数，不是字节的个数，可以使用binary，varbinary表示定长和不定长的字节个数。</li>
<li>如果不是全字段插入数据的话，需要加入字段的名字</li>
</ol>
<blockquote>
<p>注意事项：<br>
①：在做插值的操作时，值的位置要与列的字段名一一对应<br>
②：可以只指定部分列进行插值操作，其他未指定的列，将采用NULL或default默认值<br>
③：如果有自增的字段可以在插值的时候使用NULL代替<br>
④：如果列使用了非空约束，则必须插入</p>
</blockquote>
<h3 id="修改数据" tabindex="-1"><a class="header-anchor" href="#修改数据" aria-hidden="true">#</a> 修改数据</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">update</span> 表名 <span class="token keyword">set</span> 列 <span class="token operator">=</span>值<span class="token punctuation">,</span> 列 <span class="token operator">=</span>值 <span class="token punctuation">[</span><span class="token keyword">where</span> 条件<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>例子:</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 修改表中数据</span>
...
<h3 id="删除数据-delect-truncate" tabindex="-1"><a class="header-anchor" href="#删除数据-delect-truncate" aria-hidden="true">#</a> 删除数据  delect&amp;truncate</h3>
<h4 id="delect" tabindex="-1"><a class="header-anchor" href="#delect" aria-hidden="true">#</a> delect</h4>
<p><strong>删除表中的数据，但是可以通过事务回滚</strong></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">delete</span> <span class="token keyword">from</span> 表名 <span class="token punctuation">[</span><span class="token keyword">where</span> 条件<span class="token punctuation">]</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="truncate" tabindex="-1"><a class="header-anchor" href="#truncate" aria-hidden="true">#</a> truncate</h4>
<p><strong>删除原表，再创建相同的新表，</strong> ​<strong>不可以通过事务回滚</strong></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">truncate</span> <span class="token keyword">table</span> 表<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>delete和truncate的区别:</strong></p>
<p>从最终的结果来看，虽然使用TRUNCATE操作和使用DELETE操作都可以删除表中的全部记录，但是两者还是有很多区别的，其区别主要体现在以下几个方面：</p>
<ol>
<li>DELETE为数据操作语言DML；TRUNCATE为数据定义语言DDL。</li>
<li>DELETE操作是将表中所有记录一条一条删除直到删除完；TRUNCATE操作则是保留了表的结构，重新创建了这个表，所有的状态都相当于新表。因此，<strong><code v-pre>TRUNCATE操作的效率更高</code></strong>。</li>
<li>DELETE操作可以回滚；<strong><code v-pre>TRUNCATE操作会导致隐式提交，因此不能回滚</code></strong>。</li>
<li>DELETE操作执行成功后会返回已删除的行数（如删除4行记录，则会显示“Affected rows：4”）；截断操作**<code v-pre>不会返回已删除的行量</code>**，结果通常是“Affected rows：0”。DELETE操作删除表中记录后，再次向表中添加新记录时，对于设置有<code v-pre>自增约束字段的值会从删除前表中该字段的最大值加1开始自增</code>；TRUNCATE操作则会重新从1开始自增。</li>
</ol>
<h4 id="物理删除和逻辑和删除的区别" tabindex="-1"><a class="header-anchor" href="#物理删除和逻辑和删除的区别" aria-hidden="true">#</a> 物理删除和逻辑和删除的区别</h4>
<h5 id="物理删除" tabindex="-1"><a class="header-anchor" href="#物理删除" aria-hidden="true">#</a> 物理删除</h5>
<p>真正的删除了，数据不存在</p>
<h5 id="逻辑删除" tabindex="-1"><a class="header-anchor" href="#逻辑删除" aria-hidden="true">#</a> 逻辑删除</h5>
<p>没有删除，数据还在。只是在数据中添加了状态标记：Start = 1  时启用，Start = 0 时禁用</p>
</div></template>
